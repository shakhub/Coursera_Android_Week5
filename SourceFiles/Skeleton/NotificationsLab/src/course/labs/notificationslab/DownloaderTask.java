				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						if (getResultCode() != Activity.RESULT_OK) {
							...
							Notification.Builder notificationBuilder = new Notification.Builder(mApplicationContext).setSmallIcon(android.R.drawable.stat_sys_warning).setAutoCancel(true).setContentTitle("Tweet List").setContentIntent(pendingIntent).setContent(mContentView).setContentText("Download Complete");
